...
class SimpleFargateService(Blueprint):
    VARIABLES = {
        ...
        "Command": {
            "type": str,
            "description": "The command to run inside the container. If left "
                           "blank, will use the default command for the "
                           "image.",
            "default": "",
        },
        "Cluster": {
    ...
    def environment(self):
        ...
        for k, v in env_dict.items():
            env_list.append(ecs.Environment(Name=k, Value=v))
        ...
        self.task_execution_role_policy = t.add_resource(
            iam.PolicyType(
                ...
                PolicyDocument=ecs_task_execution_policy(
                    ...
                    log_stream_prefix=self.service_name + "/*"
                ),
    ...
    def create_service(self):
        ...
        t.add_output(
            Output(
                "ServiceName",
                Value=self.task_execution_role.GetAtt("Name")
            )
        )
